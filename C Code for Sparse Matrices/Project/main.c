...
int main ()
{
    ...
    srand(time(NULL));//!< To generate random numbers in matrices

    printf("Project created by Eduard Marian Balasa, student at University of Craiova\n");
    printf("Name: A library for operations with sparse matrices\n");
    printf("Professors: Costin Badica and Alexandru Becheru\n");
